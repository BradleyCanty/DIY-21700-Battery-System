...
This is a do-it-yourself battery system using 21700-form-factor cells, and is intended for use on UAVs or UGVs. The parametric nature of the system allows designing and building a lithium ion battery system specific to your vehicle's requirements. The value add is threefold:
