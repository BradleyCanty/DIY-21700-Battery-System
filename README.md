...
**The 'Battery Board', 'Vehicle Adapter', and 'Antispark Board' PCBs are designed to handle 60 amps of continuous current (assuming a maximum temperature rise of 20°C). This is the primary limiting factor in your design.**
