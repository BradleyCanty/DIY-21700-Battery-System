...
This is a do-it-yourself battery system using cells with the 21700 form factor, and is intended for use on UAVs or UGVs. The parametric nature allows designing and building a lithium ion battery system specific to your vehicle's requirements. The value add is threefold:
