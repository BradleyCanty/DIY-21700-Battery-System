...
3) the charging station (please note that this connects to a standard RC battery charger, and <ins>is not a charger itself: its an interface between the battery and the charger</ins>)
